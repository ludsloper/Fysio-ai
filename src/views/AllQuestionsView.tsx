...
type Duration = '' | 'lt6w' | '6w_3m' | '3m_12m' | 'gt12m';
      ...
      <Card className="p-4 space-y-4">
        ...
        <SelectQuestion
          ...
          options={[
            ...
            { value: '6w_3m', label: '6 weken – 3 maanden' },
            { value: '3m_12m', label: '3 – 12 maanden' },
      ...
      <Card className="p-4 space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div className="sm:col-span-2 flex items-center gap-2">
            ...
            <Button
              onClick={() => generateSummary(answers, "AIzaSyAiRh2D1WD1LYysSNEor_IiTh6szjn8X_c", setSummary, setLoadingSummary, setSummaryError)}
            >
              {loadingSummary ? 'Samenvatting laden…' : 'Genereer samenvatting'}
            </Button>
          </div>
          {/* <div className="text-xs text-muted-foreground">We tonen de samenvatting tijdelijk in de UI voor test/doeleinden.</div> */}
        </div>
        {summaryError && (
...
function AdvicePanel({ answers }: { answers: Answers }) {
  ...
  const subchronic = answers.duration === '6w_3m' || answers.duration === '3m_12m';
