...
async function main() {
  ...
  const tools = [
    {
      functionDeclarations: [
        {
          name: 'summarize_end_intake',
          description: 'Beeindig het gesprek',
        },
      ],
    }
  ];
  ...
  const config = {
    ...
    systemInstruction: {
      parts: [{
        text: `Je bent Arthur een online fysio assistante die de intake online doet en je hebt alleen kennis van fysiotherapie.`,
      }]
    },
  };
